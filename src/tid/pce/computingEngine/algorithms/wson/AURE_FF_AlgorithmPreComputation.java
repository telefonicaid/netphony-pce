...
public class AURE_FF_AlgorithmPreComputation implements ComputingAlgorithmPreComputation {
	...
	public AURE_FF_AlgorithmPreComputation(){
		log=Logger.getLogger("PCEServer");
	}
	
	public void initialize(){
		log.info("initializing AURE Algorithm");
