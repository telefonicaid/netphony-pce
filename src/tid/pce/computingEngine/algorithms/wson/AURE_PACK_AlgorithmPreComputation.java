...
public class AURE_PACK_AlgorithmPreComputation implements ComputingAlgorithmPreComputation{
	...
	public AURE_PACK_AlgorithmPreComputation(){
...
public void initialize(){
		...
		log.info("Resgistramos el algoritmo Dijkstra_PACK");
		...
		if (numLambdas>0){
			...
			log.severe("REGISTERING AURE-PACK ALGORITHM WITHOUT KNOWN NUMBER OF LAMBDAS");
			System.exit(-1);
		}
	}
