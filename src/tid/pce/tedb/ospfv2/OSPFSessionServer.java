...
public class OSPFSessionServer extends Thread {
	...
	public void run(){
		...
		try{
			...
			log.severe("Exception produced::"+UtilsFunctions.exceptionToString(e));
		}
		...
		while(true) {
			try {
				...
				e1.printStackTrace();
				log.warning("OSPF Socket ends::"+UtilsFunctions.exceptionToString(e1));
				return;
			}
