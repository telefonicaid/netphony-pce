	...
	public ComputingResponse call(){ 
		...
		if (EP.getOT()==ObjectParameters.PCEP_OBJECT_TYPE_ENDPOINTS_IPV4){
			...
			if(gep.getGeneralizedEndPointsType()==ObjectParameters.PCEP_GENERALIZED_END_POINTS_TYPE_P2P){
				...
				EndPointAndRestrictions sourceep=p2pep.getSourceEndpoint();
				EndPointAndRestrictions destep=p2pep.getDestinationEndpoint();
				source_router_id_addr=((IPv4AddressEndPoint)sourceep.getEndPoint()).getEndPointIPv4().IPv4address;
				dest_router_id_addr=((IPv4AddressEndPoint)destep.getEndPoint()).getEndPointIPv4().IPv4address;
			}
