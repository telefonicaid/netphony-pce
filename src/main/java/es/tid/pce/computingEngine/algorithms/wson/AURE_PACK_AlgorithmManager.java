...
public class AURE_PACK_AlgorithmManager implements ComputingAlgorithmManager{
	
	AURE_PACK_AlgorithmPreComputation preComp;
	...
	public ComputingAlgorithm getComputingAlgorithm(
		...
		AURE_PACK_Algorithm algo = new AURE_PACK_Algorithm(pathReq, ted,reservationManager);
	...
	public void setPreComputation(ComputingAlgorithmPreComputation pc) {
		...
		this.preComp=(AURE_PACK_AlgorithmPreComputation) pc;		
