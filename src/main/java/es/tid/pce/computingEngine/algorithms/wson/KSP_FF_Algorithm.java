...
public class KSP_FF_Algorithm implements ComputingAlgorithm {
	...
	private KSP_FF_AlgorithmPreComputation preComp;
	
	private ComputingRequest pathReq;
	
	public KSP_FF_Algorithm(ComputingRequest pathReq,TEDB ted, ReservationManager reservationManager ){
	...
	public ComputingResponse call(){ 
		...
		int j =0;
		if (nopath==false){
			for (j=0; j<routeList.size(); j++)
			{
				gp_chosen = routeList.get(j);
	...
	public void setPreComp(KSP_FF_AlgorithmPreComputation preComp) {
