...
public class KSPprecompFF_AlgorithmManager implements ComputingAlgorithmManager{
	
	KSPprecompFF_AlgorithmPreComputation preComp;
	
	private ReservationManager reservationManager;
	
	public ComputingAlgorithm getComputingAlgorithm(
			ComputingRequest pathReq, TEDB ted) {
		KSPprecompFF_Algorithm algo = new KSPprecompFF_Algorithm(pathReq, ted,reservationManager);
	...
	public void setPreComputation(ComputingAlgorithmPreComputation pc) {
		...
		this.preComp=(KSPprecompFF_AlgorithmPreComputation) pc;		
